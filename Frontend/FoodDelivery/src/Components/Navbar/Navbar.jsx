    ...
    <nav className="bg-amber-50 shadow-sm">
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <a href="#" className="text-gray-700 hover:text-amber-500 block px-3 py-2 font-medium">Home</a>
          <a href="#" className="text-gray-700 hover:text-amber-500 block px-3 py-2 font-medium">About Us</a>
          <a href="#" className="text-gray-700 hover:text-amber-500 block px-3 py-2 font-medium">Restaurants</a>
          <a href="#" className="text-gray-700 hover:text-amber-500 block px-3 py-2 font-medium">FAQ</a>
          <a href="#" className="text-gray-700 hover:text-amber-500 block px-3 py-2 font-medium">Contacts</a>
        </div>
